// ==UserScript==
// @name         padrao_anterior_posteriorBet365
...
(function () {
    ...
    function checkForNewColumn() {
      ...
      for (let i = 0; i < cells.length - 2; i++) {
        ...
        // Obtem os valores das células atual, ignora a próxima e pega a posterior
       ...
       firstValues.forEach((firstValue) => {
          ...
          if (thirdValues.includes(firstValue)) {
        ...
        if (intersectingValues.size >= 2) {
            let nova_mensagem = `Padrão 1ª e 3ª torre: \n1ª${firstValues} \n3ª${thirdValues} \nPadrões: ${Array.from(intersectingValues)}`
